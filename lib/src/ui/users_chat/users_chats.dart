      ...
      child: Row(
        children: <Widget>[
          NeumorphicRadio(
            ...
            child: Text("All",style:groupValue== "All"?TextStyle(color: NeumorphicTheme.currentTheme(context).accentColor):TextStyle()),
          ),
          Padding(
          ...
          NeumorphicRadio(
            ...
            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 6),
            child: Text("Visitors",style:groupValue== "Visitors"?TextStyle(color: NeumorphicTheme.currentTheme(context).accentColor):TextStyle()),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 6.0),
            child: Container(color: Colors.grey, width: .4,height:14,),
          ...
          NeumorphicRadio(
            ...
            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 6),
            child: Text("Agents & Admin",style:groupValue== "Agents"?TextStyle(color: NeumorphicTheme.currentTheme(context).accentColor):TextStyle()),
          ),
        ],
      ),
    );
